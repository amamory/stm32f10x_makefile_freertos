...
// Select platform automatically, if possible
  ...
  #define RH_PLATFORM RH_PLATFORM_STM32F1
...
#elif (RH_PLATFORM == RH_PLATFORM_STM32F1) // Blue pill
// TODO Amory. I have to adapt the low level part of the software to RH_PLATFORM_STM32F1 and stm32f10x.h
 ...
 //#include <string.h>
 //#include <application.h>
#include <STM32ArduinoCompat/HardwareSerial.h>
 #include <math.h> // floor
 #define RH_HAVE_SERIAL
